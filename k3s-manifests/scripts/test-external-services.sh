...
timeout 10 bash -c 'until nc -z 192.168.1.142 9200; do echo "   ⏳ Attente Elasticsearch..."; sleep 2; done' && echo "   ✅ Elasticsearch accessible" || echo "   ❌ Elasticsearch inaccessible"
